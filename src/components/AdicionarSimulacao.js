/*
 * ARQUIVO: /src/components/AdicionarSimulacao.js (VERSÃO 3.12)
 *
 * O QUE MUDOU:
 * - O "Preview da Simulação" agora mostra os detalhes das parcelas
 * (ex: "1-60: R$ X | 61-120: R$ Y") e o total de "parcelas restantes"
 *, lendo do "Cérebro" V15.
 */
    ...
    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white p-6 rounded-lg shadow-lg">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
        ...
        <div>
          ...
          <p className="text-xs opacity-80 truncate" title={preview.parcelaPre.detalhes}>{preview.parcelaPre.detalhes}</p>
        ...
        <div>
          ...
          <p className="text-lg md:text-2xl font-bold">{formatCurrency(preview.parcelaPos.valor)}</p>
           {/* CORREÇÃO V3.12: Mostra os detalhes e parcelas restantes */}
           <p className="text-xs opacity-80 truncate" title={preview.parcelaPos.detalhes}>{preview.parcelaPos.detalhes}</p>
...
export const AdicionarSimulacao = () => {
  ...
  return (
    <Accordion titulo="Adicionar Simulação" icon="simulacao" comecaAberto={true}>
      ...
      {/* --- LAYOUT CORRIGIDO: Pós-Lance e Seguro --- */}
